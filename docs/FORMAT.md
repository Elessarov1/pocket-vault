...
отдельно от контейнера. Мастер-фраза не записывается в DeviceStorage,
SecureStorage или localStorage. Разблокированная сессия и случайный DEK
существуют только в памяти WebView и уничтожаются при блокировке.
