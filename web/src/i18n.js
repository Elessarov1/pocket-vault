...
const ENGLISH = new Map(Object.entries({
  ...
  "Пароли, ключи, PIN-коды и заметки — зашифрованы на этом устройстве.": "Passwords, keys, PINs, and notes—encrypted on this device.",
  ...
  "Текущий мастер-пароль": "Current master password",
  ...
  "Добавьте ещё 2–3 случайных слова.": "Add 2–3 more random words.",
  ...
  "Фраза от 16 символов": "A phrase of at least 16 characters",
  ...
  "Я понимаю: без мастер-пароля восстановить записи невозможно.": "I understand: entries cannot be recovered without the master password.",
  ...
  "Записи шифруются на устройстве до сохранения. Telegram получает только шифротекст.": "Entries are encrypted on the device before storage. Telegram receives only ciphertext.",
  "Записи шифруются на устройстве до сохранения. В DeviceStorage хранится только шифротекст.": "Entries are encrypted on the device before storage. DeviceStorage contains only ciphertext.",
  "Для быстрого входа мастер-пароль хранится в защищённом хранилище устройства до конца текущего дня. Он не отправляется разработчику.": "For quick unlock, the master password is kept in the device’s secure storage until the end of the current day. It is never sent to the developer.",
  "Понятно": "Got it",
  "Хранилище заблокировано": "Vault locked",
  "С возвращением.": "Welcome back.",
  "Разблокируйте хранилище": "Unlock your vault",
  ...
  "Telegram получает только шифротекст": "Telegram receives only ciphertext",
  "Записи хранятся как шифротекст": "Entries are stored as ciphertext",
  ...
  "Без мастер-пароля записи не расшифровать. Можно только удалить хранилище и начать заново.": "Without the master password, entries cannot be decrypted. You can only delete the vault and start over.",
  ...
  "Удаление без проверки": "Deletion without verification",
  "Человек с доступом к этому Telegram сможет удалить хранилище, но не прочитать записи.": "Anyone with access to this Telegram client can delete the vault, but cannot read its entries.",
  ...
  "Добавьте защищённую запись": "Add an encrypted entry",
  "Все поля шифруются.": "Every field is encrypted.",
  ...
  "Потребуется текущий пароль": "Current password required",
  "Смените мастер-пароль": "Change your master password",
  "Записи останутся без изменений.": "Your entries will remain unchanged.",
  "После смены новый мастер-пароль будет сохранён для быстрого входа до конца текущего дня.": "After the change, the new master password will be remembered for quick unlock until the end of the current day.",
  ...
  "Обновите Telegram": "Update Telegram",
  "Нужен актуальный мобильный или десктопный клиент с локальным хранилищем.": "Use a current mobile or desktop client with local storage support.",
  ...
  "Обновите запись": "Update the entry",
  ...
  "Создаём…": "Creating…",
  "Введите мастер-пароль": "Enter your master password",
  "Введите текущий мастер-пароль": "Enter your current master password",
  "Новый мастер-пароль должен отличаться от текущего": "The new master password must differ from the current one",
  "Открываем…": "Opening…",
  "Меняем пароль…": "Changing password…",
  "Мастер-пароль изменён": "Master password changed",
  "Сохраняем…": "Saving…",
  ...
  "Зашифрованный контейнер хранится локально через Telegram DeviceStorage. На поддерживаемых мобильных клиентах мастер-пароль может отдельно сохраняться в Telegram SecureStorage для быстрого входа до ближайшей полуночи по локальному времени устройства. Он не записывается в DeviceStorage или localStorage. Pocket Vault не имеет собственного сервера, аккаунтов и облачной синхронизации.": "The encrypted container is stored locally through Telegram DeviceStorage. On supported mobile clients, the master password may be stored separately in Telegram SecureStorage for quick unlock until the next midnight in the device’s local time. It is not written to DeviceStorage or localStorage. Pocket Vault has no server, accounts, or cloud sync.",
  "Выбранные язык и тема интерфейса сохраняются отдельно в localStorage браузера и не содержат данных хранилища.": "The selected interface language and theme are stored separately in browser localStorage and contain no vault data.",
  "Мастер-пароль и доступ": "Master password and access",
  "Мастер-пароль не отправляется разработчику. Если клиент поддерживает быстрый вход, он хранится средствами Telegram SecureStorage, использующими защищённое хранилище устройства. Кэш действует только до конца текущего календарного дня и не продлевается автоматическими открытиями. Ручная блокировка отключает быстрый вход до следующего явного ввода. Без мастер-пароля или действующего кэша расшифровать записи невозможно; при их утрате можно только уничтожить локальное хранилище и начать заново.": "The master password is never sent to the developer. When the client supports quick unlock, it is stored through Telegram SecureStorage using the device’s protected storage. The cache lasts only until the end of the current calendar day and automatic unlocks do not extend it. Manual locking disables quick unlock until the next explicit password entry. Without the master password or a valid cache, entries cannot be decrypted; if both are lost, you can only destroy the local vault and start over.",
  "Удаление": "Deletion",
